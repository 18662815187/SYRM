                     ...
                     <div class="login-welcome">
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <img src="/images/admin/welconlogin-icon.png"/><span id="welcome">您好:${USER_NAME}!${pharmacy.id}</span>
                                    <img src="/images/admin/loginout-icon.png"/><a href="/logout.do" target="_top" id="logout" onclick="return confirm('您确定退出吗?');">退出</a> 
                              ...
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
										...
										<li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);"><a href="frame/product_main.do" target="mainFrame">产品</a></li>
